...
# Evaluation results
## Summary
- Compiles without errors: 113/128
- Interprets without errors: 94/128
- Output matches: 107/128

| File | Compiles without errors | Interprets without errors | Output matches | Time compilation | Time interpretation |
| --- | --- | --- | --- | --- | --- |
| [c_funkce_funkce_14.c](./c_funkce_funkce_14.c) | ✅ | ✅ | ✅ | 0.054 + 0.001 (0.055) | 0.033 |
| [c_promenne_promenne_3.c](./c_promenne_promenne_3.c) | ✅ | ✅ | ✅ | 0.052 + 0.001 (0.053) | 0.032 |
| [c_prace_s_pameti_ukazatele_4.c](./c_prace_s_pameti_ukazatele_4.c) | ✅ | ✅ | ✅ | 0.050 + 0.001 (0.052) | 0.032 |
| [c_prace_s_pameti_dynamicka_pamet_2.c](./c_prace_s_pameti_dynamicka_pamet_2.c) | ✅ | ✅ | ✅ | 0.060 + 0.001 (0.061) | 0.033 |
| [c_rizeni_toku_while_9.c](./c_rizeni_toku_while_9.c) | ✅ | ✅ | ✅ | 0.050 + 0.001 (0.052) | 0.033 |
| [c_prace_s_pameti_ukazatele_9.c](./c_prace_s_pameti_ukazatele_9.c) | ✅ | ✅ | ✅ | 0.051 + 0.001 (0.053) | 0.032 |
| [c_datove_typy_celociselne_typy_2.c](./c_datove_typy_celociselne_typy_2.c) | ✅ | ✅ | ✅ | 0.052 + 0.002 (0.054) | 0.033 |
| [c_funkce_funkce_2.c](./c_funkce_funkce_2.c) | ✅ | ✅ | ✅ | 0.053 + 0.001 (0.054) | 0.033 |
| [c_promenne_promenne_1.c](./c_promenne_promenne_1.c) | ✅ | ✅ | ✅ | 0.053 + 0.001 (0.054) | 0.032 |
| [c_rizeni_toku_while_8.c](./c_rizeni_toku_while_8.c) | ✅ | ✅ | ✅ | 0.052 + 0.001 (0.053) | 0.032 |
| [c_rizeni_toku_if_1.c](./c_rizeni_toku_if_1.c) | ✅ | ✅ | ✅ | 0.052 + 0.001 (0.054) | 0.033 |
| [c_funkce_funkce_13.c](./c_funkce_funkce_13.c) | ✅ | ✅ | ✅ | 0.054 + 0.001 (0.055) | 0.033 |
| [c_rizeni_toku_for_2.c](./c_rizeni_toku_for_2.c) | ✅ | ✅ | ✅ | 0.053 + 0.001 (0.054) | 0.033 |
| [c_prace_s_pameti_ukazatele_7.c](./c_prace_s_pameti_ukazatele_7.c) | ✅ | ✅ | ✅ | 0.054 + 0.001 (0.056) | 0.034 |
| [c_funkce_funkce_8.c](./c_funkce_funkce_8.c) | ✅ | ✅ | ✅ | 0.054 + 0.001 (0.055) | 0.037 |
| [c_rizeni_toku_if_2.c](./c_rizeni_toku_if_2.c) | ✅ | ✅ | ✅ | 0.061 + 0.001 (0.062) | 0.035 |
| [c_pole_staticka_pole_5.c](./c_pole_staticka_pole_5.c) | ✅ | ✅ | ✅ | 0.053 + 0.001 (0.054) | 0.034 |
| [c_text_retezce_4.c](./c_text_retezce_4.c) | ✅ | ✅ | ✅ | 0.058 + 0.001 (0.059) | 0.034 |
| [caste_chyby_caste_chyby_5.c](./caste_chyby_caste_chyby_5.c) | ✅ | ✅ | ✅ | 0.054 + 0.001 (0.055) | 0.033 |
| [c_promenne_promenne_2.c](./c_promenne_promenne_2.c) | ✅ | ✅ | ✅ | 0.069 + 0.001 (0.070) | 0.034 |
| [c_pole_staticka_pole_11.c](./c_pole_staticka_pole_11.c) | ✅ | ✅ | ✅ | 0.079 + 0.002 (0.081) | 0.036 |
| [c_datove_typy_pravdivostni_typy_2.c](./c_datove_typy_pravdivostni_typy_2.c) | ✅ | ✅ | ✅ | 0.061 + 0.001 (0.062) | 0.036 |
| [c_promenne_promenne_6.c](./c_promenne_promenne_6.c) | ✅ | ✅ | ✅ | 0.055 + 0.001 (0.056) | 0.033 |
| [c_rizeni_toku_while_7.c](./c_rizeni_toku_while_7.c) | ✅ | ✅ | ✅ | 0.049 + 0.001 (0.051) | 0.032 |
| [c_pole_staticka_pole_10.c](./c_pole_staticka_pole_10.c) | ✅ | ✅ | ✅ | 0.051 + 0.001 (0.052) | 0.033 |
| [caste_chyby_caste_chyby_2.c](./caste_chyby_caste_chyby_2.c) | ✅ | ✅ | ✅ | 0.049 + 0.001 (0.050) | 0.032 |
| [c_funkce_funkce_4.c](./c_funkce_funkce_4.c) | ✅ | ✅ | ✅ | 0.053 + 0.001 (0.055) | 0.033 |
| [c_struktury_struktury_funkce_2.c](./c_struktury_struktury_funkce_2.c) | ✅ | ✅ | ✅ | 0.051 + 0.001 (0.052) | 0.032 |
| [c_funkce_funkce_6.c](./c_funkce_funkce_6.c) | ✅ | ✅ | ✅ | 0.050 + 0.001 (0.051) | 0.033 |
| [c_funkce_funkce_3.c](./c_funkce_funkce_3.c) | ✅ | ✅ | ✅ | 0.051 + 0.001 (0.052) | 0.036 |
...
| [caste_chyby_caste_chyby_3.c](./caste_chyby_caste_chyby_3.c) | ✅ | ✅ | ✅ | 0.052 + 0.001 (0.053) | 0.034 |
...
| [c_rizeni_toku_switch_2.c](./c_rizeni_toku_switch_2.c) | ✅ | ❌ | ❌ | 0.057 + 0.001 (0.058) | 0.003 |
