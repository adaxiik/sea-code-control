...
*/ 
        struct Type
        {
            ...
            constexpr size_t size_bytes() const
            {
                ...
                switch (kind)
                {
                    case Kind::Char: return sizeof(char);
                    case Kind::I8:   return sizeof(signed char);
                    case Kind::U8:   return sizeof(unsigned char);
                    case Kind::I16:  return sizeof(signed short);
                    case Kind::U16:  return sizeof(unsigned short);
                    case Kind::I32:  return sizeof(signed int);
                    case Kind::U32:  return sizeof(unsigned int);
                    case Kind::I64:  return sizeof(signed long);
                    case Kind::U64:  return sizeof(unsigned long);
                    case Kind::F32:  return sizeof(float);
                    case Kind::F64:  return sizeof(double);
            ...
            // static auto kind_to_type(Kind kind)
            // {
            //     if(std::holds_alternative<i8_type>(kind))
